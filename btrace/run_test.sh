...
do
  ...
  do
    ...
    do
      ...
      python3 $IGNITE_HOME/btrace/analyse_YCSB.py $IGNITE_HOME/$output_file_load False $flag_append load $nb_client $workload $list_stat
      ...
      python3 $IGNITE_HOME/btrace/analyse_YCSB.py $IGNITE_HOME/$output_file_run False $flag_append run $nb_client $workload $list_stat
